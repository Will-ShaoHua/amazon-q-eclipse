...
/**
 * Custom deserializer for {@link AndExpression}.
 * Reads a JSON array of expression objects and deserializes each as a {@link NotificationExpression}.
 */
public final class AndExpressionDeserializer extends JsonDeserializer<AndExpression> {

    @Override
    public AndExpression deserialize(final JsonParser parser, final DeserializationContext ctxt) throws IOException {
